"""
Compute Vertiv's (VRT) ROIC for the most recent fiscal year using SEC
EDGAR's companyfacts API.
...
def main():
    ...
    equity_fact = annual_instant_fact(us_gaap, "StockholdersEquity", fiscal_year_end)
    cash_fact = annual_instant_fact(us_gaap, "CashAndCashEquivalentsAtCarryingValue", fiscal_year_end)
